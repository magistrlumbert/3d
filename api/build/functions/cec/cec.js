...
const driver = _neo4jDriver.default.driver(process.env.NEO4J_URI_CEC || 'bolt://3.84.244.188:7687', _neo4jDriver.default.auth.basic(process.env.NEO4J_USER || 'neo4j', process.env.NEO4J_PASSWORD_CEC || 'i-097e24bd8d65274e0'));
